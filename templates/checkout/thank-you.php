        ...
        <div id="booking-items">
            ...
            <table cellpadding="0" cellspacing="0" class="booking_item_table">
                ...
                <tr>
                    ...
                    <th style="display:none;"><?php _e( 'Night', 'wp-hotel-booking' ); ?></th>
                ...
                <tr>
                    <td colspan="3"><?php _e( 'Grand Total', 'wp-hotel-booking' ) ?></td>
                    <td>
